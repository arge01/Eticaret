...
@section('javascript')
    ...
    <script type="text/javascript" src="{{ config('app.url').'admin/' }}assets/js/pages/form_layouts.js"></script>
    <!-- /theme JS files -->

    <!-- tags input -->
    <script type="text/javascript" src="{{ config('app.url').'admin/' }}assets/js/plugins/forms/tags/tokenfield.min.js"></script>
    <script type="text/javascript" src="{{ config('app.url').'admin/' }}assets/js/pages/form_tags_input.js"></script>
    <!-- tags input -->
...
@section('content')
    <!-- 2 columns form -->
    <form class="form-horizontal" action="{{ route('yonetim.anasayfa') }}" method="post">
        {{ csrf_field() }}
        <div class="panel panel-flat">
            ...
            <h1 style="box-sizing: border-box; padding: 30px; color: red; font-weight: 800">Bu Bölüm Örnektir! <span style="font-size: 10pt">Ödeme bölümü aktif olmadığı için yazılar ve rakamlar hayalidir.</span>...</h1>
            <!-- Dashboard content -->
            <div class="row">
                <div class="col-lg-8">
                        ...
                        <div class="table-responsive">
                            <table class="table text-nowrap">
                                ...
                                <tr>
                                    <td>
                                        <div class="media-left media-middle">
                                            <a href="#"><img src="{{ config('app.url') }}assets/images/brands/facebook.png" class="img-circle img-xs" alt=""></a>
                                        </div>
                                        <div class="media-left">
                                ...
                                <tr>
                                    <td>
                                        <div class="media-left media-middle">
                                            <a href="#"><img src="{{ config('app.url') }}assets/images/brands/youtube.png" class="img-circle img-xs" alt=""></a>
                                        </div>
                                        <div class="media-left">
                                ...
                                <tr>
                                    <td>
                                        <div class="media-left media-middle">
                                            <a href="#"><img src="{{ config('app.url') }}assets/images/brands/spotify.png" class="img-circle img-xs" alt=""></a>
                                        </div>
                                        <div class="media-left">
                                ...
                                <tr>
                                    <td>
                                        <div class="media-left media-middle">
                                            <a href="#"><img src="{{ config('app.url') }}assets/images/brands/twitter.png" class="img-circle img-xs" alt=""></a>
                                        </div>
                                        <div class="media-left">
                                ...
                                <tr>
                                    <td>
                                        <div class="media-left media-middle">
                                            <a href="#"><img src="{{ config('app.url') }}assets/images/brands/bing.png" class="img-circle img-xs" alt=""></a>
                                        </div>
                                        <div class="media-left">
                                ...
                                <tr>
                                    <td>
                                        <div class="media-left media-middle">
                                            <a href="#"><img src="{{ config('app.url') }}assets/images/brands/amazon.png" class="img-circle img-xs" alt=""></a>
                                        </div>
                                        <div class="media-left">
                                ...
                                <tr>
                                    <td>
                                        <div class="media-left media-middle">
                                            <a href="#"><img src="{{ config('app.url') }}assets/images/brands/dribbble.png" class="img-circle img-xs" alt=""></a>
                                        </div>
                                        <div class="media-left">
                        ...
                        <div class="table-responsive">
                            <table class="table text-nowrap">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="media-left media-middle">
                                            <a href="#"><img src="{{ config('app.url') }}assets/images/placeholder.jpg" class="img-circle img-xs" alt=""></a>
                                        </div>
                                    ...
                                    <ul class="media-list content-group">
                                        <li class="media stack-media-on-mobile">
                                            <div class="media-left">
                                                <div class="thumb">
                                                    <a href="#">
                                                        <img src="{{ config('app.url') }}assets/images/placeholder.jpg" class="img-responsive img-rounded media-preview" alt="">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active fade in has-padding" id="messages-tue">
                                <ul class="media-list">
                                    <li class="media">
                                        <div class="media-left">
                                            <img src="{{ config('app.url') }}assets/images/placeholder.jpg" class="img-circle img-xs" alt="">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-6">
                        <fieldset style="padding: 10px">
                            <legend class="text-semibold"><i class="icon-price-tags2"></i> Site Ayarları</legend>

                            <div class="form-group">
                                <label class="col-lg-3 control-label">Site Adı: </label>
                                <div class="col-lg-9">
                                    <input name="baslik" value="{{ config('ayarlar.baslik') }}" type="text" class="form-control" placeholder="Site Adı">
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-lg-3 control-label">Site Başlığı: </label>
                                <div class="col-lg-9">
                                    <input name="description" value="{{ config('ayarlar.description') }}" type="text" class="form-control" placeholder="Site Başlığı">
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-lg-3 control-label">Site Anahtarları: </label>
                                <div class="col-lg-9">
                                    <input name="keywords" value="{{ config('ayarlar.keywords') }}" type="text" class="form-control tokenfield">
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-lg-3 control-label">Site Kurucusu: </label>
                                <div class="col-lg-9">
                                    <input style="color: #a7a7a7;" disabled name="author" value="{{ config('ayarlar.author') }}" type="text" class="form-control disbled">
                                </div>
                            </div>

                            <hr>
                            <legend class="text-semibold"><i class="icon-share3"></i> Sosyal Medya</legend>
                            <div class="form-group">
                                <label class="col-lg-3 control-label">Facebook: </label>
                                <div class="col-lg-9">
                                    <input name="facebook" value="{{ config('ayarlar.facebook') }}" type="text" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input name="twitter" value="{{ config('ayarlar.twitter') }}" type="text" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input name="instagram" value="{{ config('ayarlar.instagram') }}" type="text" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input name="youtube" value="{{ config('ayarlar.youtube') }}" type="text" class="form-control">
                                </div>
                            </div>
                            <hr>
                    ...
                    <div class="col-md-6">
                        <fieldset style="padding: 10px">
                            <legend class="text-semibold"><i class="icon-link"></i> İletişim Ayarları</legend>

                            <div class="form-group">
                                <label class="col-lg-3 control-label">Email: </label>
                                <div class="col-lg-9">
                                    <input name="mail" value="{!! config('ayarlar.mail') !!}" type="text" placeholder="example@sitename.com" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input name="tel" value="{!! config('ayarlar.tel') !!}" type="text" placeholder="+XX XXX XXX XX XX" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <textarea name="adres" rows="5" cols="5" class="form-control" placeholder="Adresinizi ekleyin!">{!! stripcslashes(config('ayarlar.adres')) !!}</textarea>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-lg-3 control-label">Maps: </label>
                                <div class="col-lg-9">
                                    <textarea name="map" rows="5" cols="5" class="form-control" placeholder="Google maps ekleyin!">{!! stripcslashes(config('ayarlar.map')) !!}</textarea>
                                </div>
                            </div>
                ...
                <div class="text-right">
                    <button type="submit" class="btn btn-primary">Ayarları güncelle <i class="icon-arrow-right14 position-right"></i></button>
                </div>
            </div>
        </div>
    </form>
