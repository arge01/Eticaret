...
@section('content')
    <div class="content">
        <!-- Floating labels -->
        <div class="row">
            <form action="{{ route('yonetim.urun.guncelle', $gelen->id) }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="col-md-12">
                    ...
                    <div class="panel panel-flat">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group form-group-material">
                                ...
                                <input required value="{{ $gelen->fiyati }}" name="title" type="fiyati" class="form-control" placeholder="Ürün fiyatı">
                            </div>
                        </div>
                    </div>
                    <!-- /text inputs -->
                    ...
                    <div class="panel panel-flat">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group form-group-material">
                                ...
                                <input required value="{{ $gelen->urun_stok->stok_adedi }}" name="stok_adedi" type="text" class="form-control" placeholder="Stok adedi">
                            </div>

                            <div class="form-group form-group-material">
                                <label class="control-label">Stok Cinsi</label>
                                <input required value="{{ $gelen->urun_stok->stok_turu }}" name="stok_turu" type="text" class="form-control" placeholder="Adet veya Kg">
                            </div>

                            <div class="form-group form-group-material">
                                <label class="control-label">Renkleri</label>
                                <input required value="{{ $gelen->urun_stok->renkleri }}" name="renkleri" type="text" class="form-control" placeholder="Kırmızı, Mavi, Yeşil">
                            </div>

                            <div class="form-group form-group-material">
                                <label class="control-label">Markası</label>
                                <input required value="{{ $gelen->urun_stok->marka }}" name="marka" type="text" class="form-control" placeholder="Markası">
                            </div>

                            <div class="form-group form-group-material">
                                <label class="control-label">Adedi</label>
                                <input required value="{{ $gelen->urun_stok->stok_cinsi }}" name="stok_cinsi" type="text" class="form-control" placeholder="xl, l, m, s">
                            </div>
...
@section('ajax')
    <script>
        ...
        setTimeout(function(){
            new PNotify({
                title: 'Güncellme işlemi yapılamadı',
