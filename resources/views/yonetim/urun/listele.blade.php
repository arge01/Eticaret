    ...
    <div class="page-header">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Ürünler</span> - Listele</h4>
            </div>
        ...
        <div class="breadcrumb-line breadcrumb-line-component">
            <ul class="breadcrumb">
                ...
                <li><a href="datatable_extension_key_table.html">Ürünler</a></li>
...
@section('content')
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title">Ürün Listesi</h5>
            <div class="heading-elements">
                <ul class="icons-list">
        ...
        <table id="ana-table" class="table datatable-show-all">
            ...
            @foreach( $urunler as $i => $urun )
                <tr id="tr-{{ $urun->id }}">
                    <td>{{ $i }}</td>
                    <td>{{ $urun->urun_adi }}</td>
                    <td><img style="width: 100%" src="{{ config('app.url').'img/'.$urun->urun_img }}" alt=""></td>
                    <td><a target="_blank" href="{{ count($urun->urun_resimleri) > 0 ? route('yonetim.resim.listele', 'id='.$urun->id) : route('yonetim.resim.ekle', $urun->id) }}">{{ count($urun->urun_resimleri) > 0 ? 'Eklenmiş/Düzenle' : 'Eklenmemiş/Ekle' }}</a></td>
                        ...
                        <ul class="list list-inline no-margin">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li><a href="{{ route('yonetim.urun.guncelle', $urun->id) }}"><i class="icon-pencil7"></i>Güncelle</a></li>
                                    <li><a class="delete" id="sil-{{ $urun->id }}" href="#"><i class="icon-bin"></i>Sil</a></li>
