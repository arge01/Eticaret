    ...
    <div class="page-header">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Referanslar</span> - Listele</h4>
            </div>
        ...
        <div class="breadcrumb-line breadcrumb-line-component">
            <ul class="breadcrumb">
                ...
                <li><a href="datatable_extension_key_table.html">Referanslar</a></li>
...
@section('content')
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title">Referans Listesi</h5>
            <div class="heading-elements">
                <ul class="icons-list">
        ...
        <table id="ana-table" class="table datatable-show-all">
            ...
            @foreach( $urunler as $i => $urun )
                <tr id="tr-{{ $urun->id }}">
                    ...
                    <td>
                        @if($urun->resmi != 'yok')
                        <img style="width: 100%" src="{{ config('app.url').'images/'.$urun->resmi }}" alt="">
                        @else
                        Resim Eklenmemiş
                        @endif
                    </td>
                        ...
                        <ul class="list list-inline no-margin">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li><a href="{{ route('yonetim.referans.guncelle', $urun->id) }}"><i class="icon-pencil7"></i>Güncelle</a></li>
