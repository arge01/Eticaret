...
@section('content')
    <div class="content">
        ...
        <!-- Floating labels -->
        <div class="row">
            <form action="{{ route('yonetim.icerik.ekle') }}" method="post">
                {{ csrf_field() }}
                <div class="col-md-12">
                    <!-- Title -->
                    ...
                    <div class="panel panel-flat panel-collapsed">
                        <div class="panel-heading">
                            <h5 class="panel-title">Menü' ye Ekle</h5>
                            <div class="heading-elements">
                                <ul class="icons-list">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <select name="ana_menu" class="select select-search">
                                    ...
                                    @foreach($menuler as $i => $ymenu)
                                        <optgroup label="{{ $ymenu->menu_adi }}">
                                            @foreach($ymenu->child as $i => $menu)
                    ...
                    <div class="panel panel-flat">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group form-group-material">
                                ...
                                <br>
                                <div class="link_olustur">
                                    <label class="control-label animate">Linki (boş bırakın ya da link verin)</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="icon-link"></i></span>
                                        <input name="link" type="text" class="form-control" placeholder="{{ route('anasayfa').'/yeni' }}">
                                    </div>
                                </div>
                            </div>
