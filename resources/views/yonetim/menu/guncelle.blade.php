...
@section('content')
    <div class="content">
        ...
        <!-- Floating labels -->
        <div class="row">
            <form action="{{ route('yonetim.menu.duzenle', $gelen->id) }}" method="post">
                {{ csrf_field() }}
                <div class="col-md-6">
                    <!-- Title -->
                    ...
                    <div class="panel panel-flat">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group form-group-material">
                                ...
                                <textarea name="menu_text" rows="5" cols="5" class="form-control" placeholder="Menü açıklaması">{{ $gelen->ana_img_yazi }}</textarea>
                            </div>
                    ...
                    <div class="panel panel-flat">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group form-group-material">
                                ...
                                <input name="alt_menu" value="@foreach($gelen->child as $alt_menu) {{ $alt_menu->menu_adi.',' }} @endforeach" id="tags-input" type="text" class="tags-input" placeholder="- Alt menu ekle">
                            </div>
