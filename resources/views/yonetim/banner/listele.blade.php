        ...
        <table id="ana-table" class="table datatable-show-all">
            ...
            @foreach( $slider as $i => $slide )
                <tr id="tr-{{ $slide->id }}">
                    ...
                    <td>{{ $slide->title }}</td>
                    <td>{{ $slide->label }}</td>
                    <td><img style="width: 100%" src="{{ config('app.url').'img/'.$slide->img }}" alt=""></td>
                        ...
                        <ul class="list list-inline no-margin">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li><a href="{{ route('yonetim.banner.duzenle', $slide->id) }}"><i class="icon-pencil7"></i>Güncelle</a></li>
