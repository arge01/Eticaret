    ...
    <div class="page-header">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Banner</span> - Banner Düzenle</h4>
            </div>
...
@section('content')
    <div class="content">
        ...
        <!-- Floating labels -->
        <div class="row">
            <form action="{{ route('yonetim.alt_banner.duzenle', $gelen->id) }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="col-md-6">
                    ...
                    <h6 class="content-group text-semibold">
                        Banner Düzenle
                        <small class="display-block">banner düzenlemek için alanları doldurun.</small>
                    </h6>
                    <!-- /title -->
                    ...
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            <h5 class="panel-title">Banner Düzenle</h5>
                            <div class="heading-elements">
                                <ul class="icons-list">
